...
Final Fantasy VII PC is notoriously difficult to speedrun competetively and not because 
...
which makes the game framerate much more stable, targetting exactly 30 FPS on fields all 
...
No configuration is neccesary. Just run the app and click "Install", select your game 
directory and you're  done. If you ever want to remove the FPS Fix just click on the 
"Uninstall" button.

Because with this fix the framerate is stable for everyone this also removes the need 
for DxTory or other FPS display tools.

SCM RNG injection
-----------------------

The PC version of Final Fantasy VII contains a glitch that makes it possible to influence
the battle RNG by changing one's system clock and then running the game at an exact time 
to make sure you'll get always the same outcome in battles. Changing your system clock 
however is something that can wreak havok on your computer - the operating system doesn't 
like that much, streaming software sometimes freaks out and there are other issues.
